"""
Unit tests for VisualizationRecommender class (mocked API tests).

These tests verify the functionality without making real API calls.
"""
...
class TestRecommendationGeneration:
    ...
    def test_get_recommendations(self, mock_query, llm_dummy_response):
        ...
        recommender.df = pd.DataFrame(columns=["value", "count", "category", "time"])
